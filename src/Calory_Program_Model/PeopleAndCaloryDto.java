...
public class PeopleAndCaloryDto {
	...
	public String toString() {
		...
		if (this.sumKcal >= 2500) {
			return " | " + idx + " | " + name + " | " + sex + " | " + age + " | " + phone + " | " + address + " | "
					+ "the amount of calory is" + sumKcal + "kcal " + " so you should eat less. | ";
		} else if(this.sumKcal<2500){
			return " | " + idx + " | " + name + " | " + sex + " | " + age + " | " + phone + " | " + address + " | "
					+ "the amount of calory is " + sumKcal + "kcal " + "so you could eat more than today. | ";
		}
		return null;
